...
public class IconsTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mRootView = inflater.inflate(ir.blockify.R.layout.fragment_icons_tab, container, false);
        return mRootView;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        listView = mRootView.findViewById(ir.blockify.R.id.images);
        ...
        IndexScrollView indexScrollView = mRootView.findViewById(ir.blockify.R.id.indexScrollView);
    ...
    public void setSelecting(boolean enabled) {
        DrawerLayout drawerLayout = ((DrawerLayout) getActivity().findViewById(ir.blockify.R.id.drawer_view));
        TabLayout subTabs = getActivity().findViewById(ir.blockify.R.id.sub_tabs);
        TabLayout mainTabs = getActivity().findViewById(ir.blockify.R.id.main_samsung_tabs);
        ViewPager2 viewPager2 = getActivity().findViewById(ir.blockify.R.id.viewPager2);

        if (enabled) {
            mSelecting = true;
            imageAdapter.notifyItemRangeChanged(0, imageAdapter.getItemCount() - 1);
            drawerLayout.setSelectModeBottomMenu(ir.blockify.R.menu.select_mode_menu, item -> {
    ...
    public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ViewHolder> {
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            switch (viewType) {
                case 0:
                    resId = ir.blockify.R.layout.icon_tab_listview_item;
                    break;
                case 1:
                    resId = ir.blockify.R.layout.icon_tab_listview_bottom_spacing;
                    break;
            }
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            ViewHolder(View itemView, int viewType) {
                ...
                if (isItem) {
                    ...
                    imageView = parentView.findViewById(ir.blockify.R.id.icon_tab_item_image);
                    textView = parentView.findViewById(ir.blockify.R.id.icon_tab_item_text);
                    checkBox = parentView.findViewById(ir.blockify.R.id.checkbox);
                }
            }
        }
    }
