...
import ir.blockify.utils.TabsManager;

public class OneUiActivity extends OneUiThemeActivity {
    ...
    private void init() {
        ...
        fab.setRippleColor(getResources().getColor(mUseOUI4Theme ? de.dlyt.yanndroid.oneui.R.color.sesl4_ripple_color : de.dlyt.yanndroid.oneui.R.color.sesl_ripple_color));
        // dummy colors
        if (mUseOUI4Theme) {
            fab.setBackgroundTintList(ColorStateList.valueOf(getResources().getColor(de.dlyt.yanndroid.oneui.R.color.sesl_swipe_refresh_background)));
            fab.setSupportImageTintList(ResourcesCompat.getColorStateList(getResources(), de.dlyt.yanndroid.oneui.R.color.sesl_tablayout_selected_indicator_color, getTheme()));
        } else {
            fab.setBackgroundTintList(ResourcesCompat.getColorStateList(getResources(), de.dlyt.yanndroid.oneui.R.color.sesl_tablayout_selected_indicator_color, getTheme()));
            fab.setSupportImageTintList(ColorStateList.valueOf(getResources().getColor(de.dlyt.yanndroid.oneui.R.color.sesl_white)));
        }
        ...
        Drawable icon = ResourcesCompat.getDrawable(getResources(), de.dlyt.yanndroid.oneui.R.drawable.ic_samsung_drawer, getTheme());
        icon.setColorFilter(getResources().getColor(de.dlyt.yanndroid.oneui.R.color.sesl_tablayout_text_color), PorterDuff.Mode.SRC_IN);
        ...
        if (tabLayout.isEnabled()) {
            ...
            if (tab != null) {
                ...
                if (tabPosition == 0) {
                    ...
                    ((androidx.drawerlayout.widget.DrawerLayout) drawerLayout.findViewById(de.dlyt.yanndroid.oneui.R.id.drawerLayout)).setDrawerLockMode(androidx.drawerlayout.widget.DrawerLayout.LOCK_MODE_UNLOCKED);
                    ...
                    ((androidx.drawerlayout.widget.DrawerLayout) drawerLayout.findViewById(de.dlyt.yanndroid.oneui.R.id.drawerLayout)).setDrawerLockMode(androidx.drawerlayout.widget.DrawerLayout.LOCK_MODE_LOCKED_CLOSED);
            ...
            mClassicColorPickerDialog = new ClassicColorPickerDialog(this,
                    new ClassicColorPickerDialog.OnColorSetListener() {
                        ...
                        public void onColorSet(int i) {
                            if (currentColor != i)
                                ThemeUtil.setColor(OneUiActivity.this, Color.red(i), Color.green(i), Color.blue(i));
                        }
                    },
                    currentColor);
    ...
    public void standardDialog(View view) {
        AlertDialog dialog = new AlertDialog.Builder(this)
                ...
                .setNegativeButtonColor(getResources().getColor(de.dlyt.yanndroid.oneui.R.color.sesl_functional_red))
                .setPositiveButtonColor(getResources().getColor(de.dlyt.yanndroid.oneui.R.color.sesl_functional_green))
    ...
    private void popupView(View view) {
        if (bnvPopupMenu == null) {
            ...
            bnvPopupMenu.setAnimationStyle(de.dlyt.yanndroid.oneui.R.style.BottomMenuPopupAnimStyle);
