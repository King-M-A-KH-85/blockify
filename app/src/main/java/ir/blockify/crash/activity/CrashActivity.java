package ir.blockify.crash.activity;
...
public final class CrashActivity {
    ...
    private static final String EXTRA_CONFIG = "ir.blockify.EXTRA_CONFIG";
    private static final String EXTRA_STACK_TRACE = "ir.blockify.EXTRA_STACK_TRACE";
    private static final String EXTRA_ACTIVITY_LOG = "ir.blockify.EXTRA_ACTIVITY_LOG";
    //General constants
    private static final String INTENT_ACTION_ERROR_ACTIVITY = "ir.blockify.ERROR";
    private static final String INTENT_ACTION_RESTART_ACTIVITY = "ir.blockify.RESTART";
    private static final String CRASH_HANDLER_PACKAGE_NAME = "ir.blockify.";
    private static final String DEFAULT_HANDLER_PACKAGE_NAME = "com.android.internal.os";
    private static final int MAX_STACK_TRACE_SIZE = 131071; //128 KB - 1
    private static final int MAX_ACTIVITIES_IN_LOG = 50;
    //Shared preferences
    private static final String SHARED_PREFERENCES_FILE = "ir.blockify_preferences";
