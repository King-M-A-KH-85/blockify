...
public class MainActivitySecondFragment extends PreferenceFragment
    ...
    public void onAttach(Context context) {
        ...
        if (getActivity() instanceof OneUiActivity)
            mActivity = ((OneUiActivity) getActivity());
        mContext = getContext();
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        getView().setBackgroundColor(getResources().getColor(de.dlyt.yanndroid.oneui.R.color.item_background_color));
    }
