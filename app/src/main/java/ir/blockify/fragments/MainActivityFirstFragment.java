...
import ir.blockify.tabs.ViewPager2Adapter;

public class MainActivityFirstFragment extends Fragment {
    private OneUiThemeActivity mActivity;
    ...
    public void onAttach(Context context) {
        ...
        mActivity = (OneUiThemeActivity) getActivity();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        getView().setBackgroundColor(getResources().getColor(mActivity.mUseOUI4Theme ? de.dlyt.yanndroid.oneui.R.color.sesl4_round_and_bgcolor : de.dlyt.yanndroid.oneui.R.color.sesl_round_and_bgcolor));
